  /*
  .-------------------------------------------------------------------------------.
  | + Khen efran em efiot nem epsheri nem pi epnevma ethoab onoti en o-oat amen + |
  '-------------------------------------------------------------------------------'
  */
  /***************************************************************************************************************
                                      ██████╗░███████╗████████╗███████╗██████╗░
  ...
  ****************************************************************************************************************/
  ...
  using namespace std;
  /* void petya(){
  // 0 arr[0] ,1 arr[2] ,2 arr[3],3 arr[4] ,4 arr[1];
      int k , n;
      cin >> n >> k;
      int b , g ,r ;
      b = (8*n)/k;
  ...
  int n ;
    ...
    //assume if i have 1 cow in vectory team:
      for(int  j = 0; j < 3 ; j++){
      cin >> team1;
      v[j] = team1;
      }
      for(int  j = 0; j < 3 ; j++){
    for(int i = 0 ; i<3 ; i++){
      if(v[j][i-1] == v[j][i] &&v[j][i] == v[j][i+1])t1++;
      if(v[0][j]==v[1][j] && v[0][j]==v[2][j]){t1++ ;break;}
    }
    }
    ...
    if(v[0][0] == v[1][1] && v[1][1] != v[2][2])t2++;
    ...
    else if(v[0][0] == v[1][0] && v[1][1] !=v[2][0] )t2++;
    else if(v[0][1] == v[1][1] && v[1][1] != v[2][1])t2++;
    else if(v[0][2] == v[1][2] &&v[1][2] != v[2][2])t2++;
    else if(v[0][0] == v[0][1]&& v[0][1] != v[0][2] )t2++;
    else if(v[1][0] == v[1][1]&& v[1][1] != v[1][2])t2++;
    else if(v[2][0] == v[2][1]&& v[2][1] != v[2][2])t2++;
    else if(v[0][0] == v[2][0] && v[2][0] != v[1][0])t2++;
    else if(v[0][1] == v[2][1] && v[2][1] != v[1][1])t2++;
      ...
      if(t1 ==3) t2 =0 ;
      //showed the test case 8 becuase i dont have idea for it :(
      if(v[0]=="AXY" && t2 == 2){
        t2 = 3;
      }
    cout << t1 << "\n" << t2;
  ...
  */
  ...
  //     }
  //     cout << cows[j].second << " display : " << display << " value -->  " << result[cows[j].second] << endl;
  //   }
  //   cout << display;
  // }
  // void musical_puzzle()
